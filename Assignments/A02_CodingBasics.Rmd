...
#2. 
mean<-mean(fours_sequence) #assigning a name 
median<-median(fours_sequence) #assigning a name 
mean
median
...
studentnames <- c('Anna','Tom','Lucas','Lucy') #Type character
...
> Answer:In a data frame the columns contain different types of data, but in a matrix all the elements are the same type of data. A matrix in R is like a mathematical matrix, containing all the same type of thing (usually numbers). R often but not always lets these be used interchangably.
