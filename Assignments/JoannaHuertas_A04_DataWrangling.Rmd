...
write.csv(EPAairO32018.select, row.names = FALSE, file = "./Data/Processed/EPAair_O3_NC2018_processed.csv")

write.csv(EPAairO32019.select, row.names = FALSE, file = "./Data/Processed/EPAair_O3_NC2019_processed.csv")

write.csv(EPAairPM2018.select, row.names = FALSE, file = "./Data/Processed/EPAair_PM25_NC2018_processed.csv")

write.csv(EPAairPM2019.select, row.names = FALSE, file = "./Data/Processed/EPAair_PM25_NC2019_processed.csv")
...
write.csv(EPAairPM2019.select, row.names = FALSE, file = "./Data/Processed/EPAair_O3_PM25_NC1819_Processed.csv")
