...
> Answer: I have used Github for a summer project in which we were required to use R shiny and for an Environmental Spatial Analysis class using Python.

2. Are there any components of the course about which you feel confident?

> Answer: I hope I can remember some coding in R so I can clean the data smoothly

3. Are there any components of the course about which you feel apprehensive?

> Answer: The bugs and the Statistics part
...
> Answer: https://github.com/joa-kenit/EDA-Spring2023
