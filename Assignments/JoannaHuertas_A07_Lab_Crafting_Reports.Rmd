...
```{r echo=FALSE, fig.align="left", fig.height=3, fig.cap= 'Ozone Level by month - 2018', warning=FALSE, out.width='0.99\\textwidth'}
#filtering 2018
Ozone_2018 <- epa_data %>% 
  filter(Year==2018)%>%
...
# Create boxplot of ozone levels by month for 2018
ggplot(Ozone_2018, aes(x = as.factor(Month), y = Ozone)) +
  geom_boxplot() +
  labs(title = "Ozone Levels by Month - 2018", x = "Month",
...
# Create boxplot of ozone levels by month for 2018
ggplot(Ozone_2019, aes(x = as.factor(Month), y = Ozone)) +
  geom_boxplot() +
  labs(title = "Ozone Levels by Month - 2019", x = "Month",
       y = expression (Ozone ~(mu*g / m^3)))
```
...
### Git Repository
https://github.com/joa-kenit/EDA-Spring2023
